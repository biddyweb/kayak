package org.mapsforge.applications.android.samples.filepicker;
...
import org.mapsforge.applications.android.samples.filefilter.ValidFileFilter;
 ...
 * <p>
 * Another <code>FileFilter</code> can be applied via {@link #setFileSelectFilter(org.mapsforge.applications.android.samples.filefilter.ValidFileFilter)} to check if a
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        switch (id) {
            case DIALOG_FILE_INVALID:
                ...
                builder.setTitle(R.string.file_picker_error);

                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append(getString(R.string.file_picker_file_invalid));
                stringBuilder.append("\n\n");
                stringBuilder.append(FilePicker.fileSelectFilter.getFileOpenResult().getErrorMessage());

                builder.setMessage(stringBuilder.toString());
                builder.setPositiveButton(R.string.file_picker_ok, null);
                return builder.create();
            case DIALOG_FILE_SELECT:
                builder.setMessage(R.string.file_picker_file_select);
                builder.setPositiveButton(R.string.file_picker_ok, null);
                return builder.create();
            default:
