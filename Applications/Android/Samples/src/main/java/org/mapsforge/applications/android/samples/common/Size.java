 ...
 * zusammen klappt und ab Gingerbread die File-Methoden benutzt. Sie nutzt ein {@link android.util.Pair} zum
...
public class Size extends Pair<Long,Long> {
	...
	/**
	 * Ermittelt die Gr��e und den freien Speicher des �bergebenen {@link java.io.File}. Ab
	 * Android 2.3 werden dazu die File-Methoden {@link java.io.File#getUsableSpace()} und
	 * {@link java.io.File#getTotalSpace()} benutzt, bei �lteren Android-Versionen wird ein
	 * Hilfsobjekt {@link android.os.StatFs} erzeugt.
	 * 
	 * @param f das Verzeichnis, dessen Gr��e ermittelt werden soll
	 * @return ein {@link android.util.Pair}, das Gr��e und freier Speicher der Partition enth�lt,
